...
void MavLinkFtpClient::list(MavLinkFtpProgress& progress,
...
void MavLinkFtpClient::get(MavLinkFtpProgress& progress,
                           const std::string& remotePath,
...
void MavLinkFtpClient::put(MavLinkFtpProgress& progress,
                           const std::string& remotePath,
                           const std::string& localPath) {
  auto ptr = dynamic_cast<MavLinkFtpClientImpl*>(pImpl.get());
...
void MavLinkFtpClient::remove(MavLinkFtpProgress& progress,
                              const std::string& remotePath) {
  auto ptr = dynamic_cast<MavLinkFtpClientImpl*>(pImpl.get());
  ptr->remove(progress, remotePath);
}

void MavLinkFtpClient::mkdir(MavLinkFtpProgress& progress,
                             const std::string& remotePath) {
  auto ptr = dynamic_cast<MavLinkFtpClientImpl*>(pImpl.get());
  ptr->mkdir(progress, remotePath);
}

void MavLinkFtpClient::rmdir(MavLinkFtpProgress& progress,
                             const std::string& remotePath) {
  auto ptr = dynamic_cast<MavLinkFtpClientImpl*>(pImpl.get());

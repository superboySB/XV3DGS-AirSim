...
MavLinkVehicle::~MavLinkVehicle() { pImpl = nullptr; }
...
AsyncResult<bool> MavLinkVehicle::waitForAltitude(float z, float dz,
                                                  float dvz) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
  return ptr->waitForAltitude(z, dz, dvz);
}

AsyncResult<bool> MavLinkVehicle::land(float yaw, float lat, float lon,
                                       float altitude) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
...
AsyncResult<bool> MavLinkVehicle::setMode(int modeFlags, int customMode,
                                          int customSubMode, bool waitForAck) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
...
void MavLinkVehicle::moveToLocalPosition(float x, float y, float z, bool isYaw,
                                         float yawOrRate) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
  ptr->moveToLocalPosition(x, y, z, isYaw, yawOrRate);
}

void MavLinkVehicle::moveToGlobalPosition(float lat, float lon, float alt,
                                          bool isYaw, float yawOrRate) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
  ptr->moveToGlobalPosition(lat, lon, alt, isYaw, yawOrRate);
}

void MavLinkVehicle::moveByLocalVelocity(float vx, float vy, float vz,
                                         bool isYaw, float yawOrRate) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
  ptr->moveByLocalVelocity(vx, vy, vz, isYaw, yawOrRate);
}

void MavLinkVehicle::moveByLocalVelocityWithAltHold(float vx, float vy, float z,
                                                    bool isYaw,
                                                    float yawOrRate) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
...
void MavLinkVehicle::moveByAttitude(float roll, float pitch, float yaw,
...
void MavLinkVehicle::writeMessage(MavLinkMessageBase& message,
                                  bool update_stats) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
...
AsyncResult<bool> MavLinkVehicle::setHomePosition(float lat, float lon,
                                                  float alt) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
...
AsyncResult<bool> MavLinkVehicle::setVTOLState(bool fixedWing) {
  auto ptr = static_cast<MavLinkVehicleImpl*>(pImpl.get());
  return ptr->setVTOLState(fixedWing);
}

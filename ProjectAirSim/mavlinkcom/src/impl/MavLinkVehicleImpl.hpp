...
class MavLinkVehicleImpl : public MavLinkNodeImpl {
 ...
 public:
  ...
  // degrees). If the rollRate, pitchRate and yawRate are all zero then you will
 ...
 private:
  virtual void handleMessage(std::shared_ptr<MavLinkConnection> connection,
 ...
 private:
  ...
  // this latch is reset even time we receive a heartbeat, this is useful for
  // operations that we want to throttle to the heartbeat rate.
